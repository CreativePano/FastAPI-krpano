...
# 2.电影青橙：这个滤镜可以让图片有一种电影的感觉，适用于色彩不鲜明的图片 MovieOrange
...
# 3.卡梅尔 : 这个滤镜可以让图片多一点蓝调，适用于原图片很暗的效果 Kameel
...
# 4.动漫青森,这个滤镜可以让图片看起来有一种动漫的感觉 Aomori
...
# 5.这个滤镜可以让图片看起来有一种南法假日的感觉，适合晴天街景 SouthFrance
...
# 6. 接收参数为 base64 字符串、亮度、饱和度、色温和色调
